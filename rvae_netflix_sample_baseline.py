# -*- coding: utf-8 -*-
"""rvae_netflix_sample_baseline.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Vfzdnx-xqYIzx0JWXB8Zmk2Dj4vgrCjQ
...
class DataLoader:
    def __init__(self, file_tr, pos_neg_ratio=10, negatives_in_test=100, use_popularity=False, lower_bound=0, upper_bound=3):
    ...
    def _generate_training_pairs(self, pos):
        ...
        if self.use_popularity or len(pos) == 1:
            l = min(self.lower_bound,len(pos))
            u = min(self.upper_bound,len(pos))

            assert l<=u

            ordered_pos = sorted(pos, key=lambda item: self.item_popularity[item])

            positives = ordered_pos[l : u]*self.pos_neg_ratio
            negatives = self._sample_negatives(pos, (u-l)*self.pos_neg_ratio) 
